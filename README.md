...
The results of that study made clear that adults are better in predictive processing than children.
...
The test that was done by Waite et al. (2025) will be recreated in this project. 
The difference will be that there will not be human participants, but language models (LMs) with incremental amounts of training data to simulate the difference in age. 
